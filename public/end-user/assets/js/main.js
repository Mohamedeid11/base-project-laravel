...
(function($) {
    ...
    if ($(".price-range").length) {
        $(".price-range").slider({
            ...
            max: 10000,
            values: [1000, 5000],
            slide: function(event, ui) { $("#price-amount").val("L.E " + ui.values[0] + " - L.E" + ui.values[1]); }
        });
        $("#price-amount").val("L.E " + $(".price-range").slider("values", 0) + " - L.E " + $(".price-range").slider("values", 1));
    }
