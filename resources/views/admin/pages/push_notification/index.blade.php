            ...
            <div class="card">
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        <!--begin::Toolbar-->
                        @adminCan('push_notification.create')
                            <!--end::Group actions-->
                            <a href="{{ route('admin.push_notification.create') }}" class="btn btn-primary btn-sm">Push Notification</a>
                        @endadminCan
                    </div>
                    <!--end::Card toolbar-->
                </div>
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                        ...
                        <tbody class="fw-bold text-gray-600">
                            ...
                            <tr>
                                ...
                                <!--begin::Email=-->
                                <td>
                                    <a href="#" class="text-gray-600 text-hover-primary mb-1">{{ $notification->getTitle() }}</a>
                                </td>
                                 <td>
                                    <a href="#" class="text-gray-600 text-hover-primary mb-1">{{ $notification->getMessage() }}</a>
                                </td>
                                <td>
                                ...
                                <td class="text-end">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                        ...
                                        @adminCan('push_notification.delete')
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <form action="{{ route('admin.push_notification.destroy',$notification->id)}}" method="POST">
                                                @csrf
                                                @method('DELETE')
