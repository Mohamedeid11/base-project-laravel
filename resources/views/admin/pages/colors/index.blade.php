            ...
            <div class="card">
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        <!--begin::Toolbar-->
                         @adminCan('colors.create')
                        <!--end::Group actions-->
                        <a href="{{ route('admin.color.create') }}" class="btn btn-primary btn-sm">Add Color</a>
                        @endadminCan
                    </div>
                    <!--end::Card toolbar-->
                </div>
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                        ...
                        <tbody class="fw-bold text-gray-600">
                            ...
                            <tr>
                                ...
                                <!--begin::Email=-->
                                <td>
                                    <a href="#" class="text-gray-600 text-hover-primary mb-1">{{ $color->name }}</a>
                                </td>
                                <td>
                                    <input type="color" value="{{ $color->value }}" width="50" height="50">
                                </td>
                                <td>
                                    {{ $color->getCreatedAt() }}
                                </td>
                                ...
                                <td class="text-end">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                        @adminCan('colors.edit')
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <a href="{{ route('admin.color.edit',$color->id) }}" class="menu-link px-3">Edit</a>
                                        </div>
                                        <!--end::Menu item-->
                                        @endadminCan
                                        @adminCan('cities.delete')
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
